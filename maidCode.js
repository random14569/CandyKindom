...
var CardFlag=[0,0,0,0,0,0,0,0]; //目前手牌
...
function checkCard() //確認目前手牌
{
	...
	if(document.getElementById("card7").children.length > 0) { CardFlag[6]=1; }
	else { CardFlag[6]=0; emptyCard+=1; }

	if(document.getElementById("card8").children.length > 0) { CardFlag[7]=1; }
	else { CardFlag[7]=0; emptyCard+=1; }
}
...
function showButton()
{
	...
	else if(state == 3)
	{
		document.getElementById("btnGetCard").style.display="none"; 
		document.getElementById("btnClean").style.display="none"; 
		document.getElementById("btnGiveUp").style.display="inline"; 
		document.getElementById("btnQuit").style.display="none";
		document.getElementById("btnPath").style.display="none";
		document.getElementById("btnPathQuit").style.display="none";
	}
...
function moveState(i)
{
	...
	else
	{
		...
		{ 
			switch(character){
				case 1:
					charterPic.src="ImgCharter/maidright.png";
					character=4;
					break;
				case 2:
					charterPic.src="ImgCharter/maidleft.png";
					character=3;
					break;
				case 3:
					charterPic.src="ImgCharter/maidfront.png";
					character=1;
					break;
				case 4:
					charterPic.src="ImgCharter/maidback.png";
					character=2;
					break;
			}
...
function checkIfCard()
{
	...
	if(document.getElementById("Box1").children.length == 0 && emptyPlayingCard == 1) { moveFlag = 2; }
	...
	var whileCallback = function () {
		...
		if (count > 15) 
		{
			Swal.fire({
			  ...
			  html: 
			  '<h5>已進入無限迴圈!</h5>  <a href="knight.html" class="btn btn-primary">Back</a>'
			})
...
{
	document.getElementById("card1").style="1px #ccc dashed;";
	document.getElementById("card2").style="1px #ccc dashed;";
	document.getElementById("card3").style="1px #ccc dashed;";
	document.getElementById("card4").style="1px #ccc dashed;";
	document.getElementById("card5").style="1px #ccc dashed;";
	document.getElementById("card6").style="1px #ccc dashed;";
	document.getElementById("card7").style="1px #ccc dashed;";
	choose=0;
	event.preventDefault();
	if(state==3)
	{
		choose=event.currentTarget.id
		document.getElementById(choose).style="border:1px #0000FF; border-style:solid;"
	}
}
function GiveUpCard()
{
	if(state==3)
	{
		if(choose==0 || document.getElementById(choose).children.length == 0)
		{
			Swal.fire({
				type: 'error',
				title: 'Oops...',
