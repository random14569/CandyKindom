...
var rdmArray = [0,35,20,91,84,1,78,42,49,94,
			  85,36,10,63,43,56,21,92,48,50,
			  79,64,30,2,11,70,5,86,51,12,71,
			  13,37,3,58,97,95,45,80,4,59,46,
			  72,22,52,47,73,100,99];          //儲存地圖陣列
...
function showFirst()  //初始化
{
	...
	document.getElementById("screen").style.width=window.screen.width;
}
...
function moveState(i)
{
	...
	else
	{
		...
		{ 
			...
			switch(character){
				case 1:
					charterPic.src="ImgCharter/right1.png";
					character=4;
					break;
				case 2:
					charterPic.src="ImgCharter/left1.png";
					character=3;
					break;
				case 3:
					charterPic.src="ImgCharter/front1.png";
					character=1;
					break;
				case 4:
					charterPic.src="ImgCharter/back1.png";
					character=2;
					break;
			}
	...
	var whileCallback = function () {
		...
		if (count > 15) 
		{
			Swal.fire({
			  ...
			  html: 
			  '<h5>已進入無限迴圈!</h5>  <a href="try.html" class="btn btn-primary">Back</a>'
			})
