...
function StartCard()   //起手卡牌
{
	...
	'</div>';
	IfCardData();
	document.getElementById("IfCard2").innerHTML=
		'<div class="card border-warning mb-3" style="width: 108px; height:68px" id="'+ifcard[nowIfCard]+'" draggable="true" ondragstart="Drag(event)">'+
		'<img src="ImgCard/'+picindex+'.png" class="card-img-top" style="width: 108px; height:68px;" alt="" >'+
	'</div>';
	CardData();
...
function moveState(i)
{
	...
	else
	{
		...
		{ 
			switch(character){
				case 1:
					charterPic.src="ImgCharter/knightright.png";
					character=4;
					break;
				case 2:
					charterPic.src="ImgCharter/knightleft.png";
					character=3;
					break;
				case 3:
					charterPic.src="ImgCharter/knightfront.png";
					character=1;
					break;
				case 4:
					charterPic.src="ImgCharter/knightback.png";
					character=2;
					break;
			}
