...
function moveState(i)
{
	...
	else
	{
		...
		{ 
			switch(character){
				case 1:
					charterPic.src="ImgCharter/kingright.png";
					character=4;
					break;
				case 2:
					charterPic.src="ImgCharter/kingleft.png";
					character=3;
					break;
				case 3:
					charterPic.src="ImgCharter/kingfront.png";
					character=1;
					break;
				case 4:
					charterPic.src="ImgCharter/kingback.png";
					character=2;
					break;
			}
	...
	var whileCallback = function () {
		...
		if (count > 15) 
		{
			Swal.fire({
			  ...
			  html: 
			  '<h5>已進入無限迴圈!</h5>  <a href="King.html" class="btn btn-primary">Back</a>'
			})
