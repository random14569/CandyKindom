...
function moveState(i)
{
	...
	else
	{
		...
		{ 
			switch(character){
				case 1:
					charterPic.src="ImgCharter/baronright.png";
					character=4;
					break;
				case 2:
					charterPic.src="ImgCharter/baronleft.png";
					character=3;
					break;
				case 3:
					charterPic.src="ImgCharter/baronfront.png";
					character=1;
					break;
				case 4:
					charterPic.src="ImgCharter/baronback.png";
					character=2;
					break;
			}
	...
	var whileCallback = function () {
		...
		if (count > 15) 
		{
			Swal.fire({
			  ...
			  html: 
			  '<h5>已進入無限迴圈!</h5>  <a href="Baron.html" class="btn btn-primary">Back</a>'
			})
